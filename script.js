...
function fillRow1(container) {
    ...
    const keys = [
        {shifed: '', shifted_ru: 'Ё', shifted_en: '~', keyCode: 192, ru: 'ё', en: '\`', width: 1},
        {shifed: '!', keyCode: 49, value: '1', width: 1},
        {shifed: '', shifted_ru: '"', shifted_en: '@', keyCode: 50, value: '2', width: 1},
        {shifed: '', shifted_ru: '№', shifted_en: '#', keyCode: 51, value: '3', width: 1},
        {shifed: '', shifted_ru: ';', shifted_en: '$', keyCode: 52, value: '4', width: 1},
        {shifed: '%', keyCode: 53, value: '5', width: 1},
        {shifed: '', shifted_ru: ':', shifted_en: '^', keyCode: 54, value: '6', width: 1},
        {shifed: '', shifted_ru: '?', shifted_en: '&', keyCode: 55, value: '7', width: 1},
        {shifed: '*', keyCode: 56, value: '8', width: 1},
        {shifed: '(', keyCode: 57, value: '9', width: 1},
        {shifed: ')', keyCode: 48, value: '0', width: 1},
        {shifed: '_', keyCode: 189, value: '-', width: 1},
        {shifed: '+', keyCode: 187, value: '=', width: 1},
...
function fillRow3(container) {
    ...
    const keys = [
        ...
        {keyCode: 13, title: 'Enter', width: 2},
    ]
    fillKeys(row, keys);
...
function fillRow4(container) {
    ...
    const keys = [
        ...
        {keyCode: 16, title: 'up', width: 1},
        {keyCode: 38, title: 'Shift', width: 1},
    ]
    fillKeys(row, keys);
